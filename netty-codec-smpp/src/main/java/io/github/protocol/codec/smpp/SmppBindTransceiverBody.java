...
public class SmppBindTransceiverBody {
    ...
    public SmppBindTransceiverBody(String systemId, String password, String systemType,
                                   byte interfaceVersion, byte addrTon, byte addrNpi,
                                   String addressRange) {
